...
import { CircularProgress, ListItem, TextField } from '@material-ui/core';
import { Grid, ListItemText, Button } from '@material-ui/core';

export class EditSearch extends Component {
    state = {
        search: '',
        loading: false,
        items: []
